...
', 'novellite' ), $theme_data->get( 'Name' )),
        ...
        'demo_title' => esc_html__( 'Step 5 - Import Demo Content', 'novellite' ),
        'demo_link' => esc_url('//www.themehunk.com/demo/'),
        'demo_text' => sprintf(esc_html__('You can import demo from here.', 'novellite'), $theme_data->get( 'Name' )),
        'demo_button' => sprintf( esc_html__('Import the Demo', 'novellite'), $theme_data->get( 'Name' )),
        );
    return $config;
}
...
Go to your dashboard. Create a new page and select "Front Page Template" from page attribute.','novellite')?> </p></li>
            ...
            <p><a target="_blank" href="<?php echo $theme_config['theme_doc_link']; ?>"><?php  echo $theme_config['doc_link_text']; ?></a></p>
             <a target="_blank" href="<?php echo $theme_config['support_link']; ?>" target="_blank" class="button button-secondary"><?php echo $theme_config['support_button']; ?></a>
                ...
                <div class="theme_link theme-demo">
                        ...
                        <p class="about"><ol>
                                <li><p><?php esc_html_e(' 
                                Install recommended plugins','novellite')?> </p></li>
                                <li><p><?php esc_html_e('Click this button and import desired demo.','novellite')?></p></li>
                                </ol></p>
                        <p>
                               <?php
            ...
            if ( file_exists( WP_PLUGIN_DIR . '/one-click-demo-import/one-click-demo-import.php' ) && is_plugin_inactive( 'one-click-demo-import/one-click-demo-import.php' )){
              ...
              $button_text = __( 'Activate Importer Plugin', 'novellite' );
              ...
              $button_text = __( 'Install Importer Plugin', 'novellite' );
              $data_slug   = 'one-click-demo-import';
              $data_init   = '/one-click-demo-import/one-click-demo-import.php';
              ...
              $class       = 'active';
              $button_text = __( 'See Library', 'novellite' );
